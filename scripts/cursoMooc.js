...
//         element.tipo_proceso == 3 && formacionesCTutor.push(element);
//       });
...
//   window.location.href.includes("CursoMoocPage") &&
//     fetch(
//       "https://pruebascrud.formaciones.planestic.udistrital.edu.co/v1/tipo_proceso.php?id=3"
//     )
//       .then((response) => {
...
listarCursosTutorFetch(8);

buscarTipoFormacion(8);
