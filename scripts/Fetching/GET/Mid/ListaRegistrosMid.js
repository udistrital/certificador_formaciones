const listaRegistrosMid = async (id_cohorte, id_modulo) => {
  ...
  console.log(id_modulo === undefined);

  const requestOptions = {
    method: "GET",
    redirect: "follow",
  };
  const url = `https://pruebascrud.formaciones.planestic.udistrital.edu.co/mid/registro.php?id_cohorte=${id_cohorte}${id_modulo === 0 || id_modulo === undefined ? "" : "&id_modulo=" + id_modulo}`;
